...
VIZ_EXPECTATIONS: dict[str, str] = {
    ...
    "peak_sales_hours_not_supported": "bar (Hour × MTDSales)",
    ...
    "discount_impact_sales": "bar (Category × ImpliedDiscountPct)",
    "store_ranking_sales_ats_customers": "bar (Store ranking)",
    "product_recommendation_customer": "bar/table (Item × repeat buyers)",
    "demand_forecast_store_category": "bar/table (Store×Category forecast)",
    "daily_sales_target_achievement": "area/line (Day × AchievementPct)",
    ...
    "ai_business_insights_snapshot": "table (executive KPI snapshot)",
}
