...
export default function Sidebar() {
  const { sidebarExpanded, setSidebarExpanded } = useNavigation();
  ...
  return (
    <motion.aside
      ...
      style={{
        ...
        borderRight: isDark ? '1px solid rgba(88,130,255,0.1)' : '1px solid rgba(88,130,255,0.12)',
        boxShadow: isDark ? '4px 0 32px rgba(0,0,0,0.4)' : '4px 0 16px rgba(0,0,0,0.06)',
      }}
    >
      {/* Logo */}
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          >
            ...
            <div
              ...
              style={{ boxShadow: '0 0 20px rgba(88,130,255,0.7)' }}
            />
          </motion.div>
          <AnimatePresence>
            {sidebarExpanded && (
              ...
              return (
                ...
                >
                  ...
                  <Icon
                    ...
                    style={{ color: isActive ? '#5882ff' : undefined }}
                  />
